...
type DictionaryServiceClient interface {
	...
	GetTranslations(ctx context.Context, in *Word, opts ...grpc.CallOption) (*Translations, error)
}
...
func (c *dictionaryServiceClient) GetTranslations(ctx context.Context, in *Word, opts ...grpc.CallOption) (*Translations, error) {
	out := new(Translations)
	err := c.cc.Invoke(ctx, "/dictionary.DictionaryService/GetTranslations", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DictionaryServiceServer interface {
	...
	GetTranslations(context.Context, *Word) (*Translations, error)
...
func (UnimplementedDictionaryServiceServer) GetTranslations(context.Context, *Word) (*Translations, error) {
...
func _DictionaryService_GetTranslations_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Word)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DictionaryServiceServer).GetTranslations(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dictionary.DictionaryService/GetTranslations",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DictionaryServiceServer).GetTranslations(ctx, req.(*Word))
	}
	return interceptor(ctx, in, info, handler)
}
...
var DictionaryService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _DictionaryService_GetTranslations_Handler,
		},
	},
